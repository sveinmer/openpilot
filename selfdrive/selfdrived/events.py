...
EVENTS: dict[int, dict[str, Alert | AlertCallbackType]] = {
  ...
  # T2A Item 10: pedal calibration gate for Pre-AP no-pedal startup.
  # Ported from NotAutopilot/openpilot c0ac6e54e events.py lines 818-821.
  ...
  # T2A Item 10: Tesla CC stock engagement events (no-pedal mode).
  # Ported from NotAutopilot/openpilot c0ac6e54e events.py lines 1047-1065.
